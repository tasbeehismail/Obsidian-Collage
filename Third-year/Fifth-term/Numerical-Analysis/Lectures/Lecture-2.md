...
+ ##### Well-conditioned (insensitive) problem:
	+ A small change in input, leads to small changes in result.
+ ##### Ill-conditioned (sensitive) problem:
	+ Any small changes in the original problem, cause dramatic changes in result.
 
 | Original Problem | |
 | :-:| :-: | 
 |![](https://github.com/tasbeehismail/Obsidian-Collage/blob/main/Third-year/Fifth-term/Numerical-Analysis/Images/L3-Ex1.png)| |
 ...
 | :-:| :-: | 
 |![](https://github.com/tasbeehismail/Obsidian-Collage/blob/main/Third-year/Fifth-term/Numerical-Analysis/Images/L3-Ex2.png)| |


 | <span class="red">Not Has A Solution!!!</span> | |
 | :-:| :-: | 
 |![](https://github.com/tasbeehismail/Obsidian-Collage/blob/main/Third-year/Fifth-term/Numerical-Analysis/Images/L3-Ex3.png)| |
